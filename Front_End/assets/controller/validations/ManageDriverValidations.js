...
driverValidations.push({
    reg: regDriverID,
    field: $('#user_Id'),
    error: 'Diver ID Pattern is Wrong'
});
driverValidations.push({
    reg: regFirstName,
    field: $('#firstName'),
    error: 'Diver First Name Pattern is Wrong'
});
driverValidations.push({
    reg: regLastName,
    field: $('#lastName'),
    error: 'Diver Last Name Pattern is Wrong'
});
driverValidations.push({
    reg: regContactNum,
    field: $('#contact_No'),
    error: 'Diver Contact Number Pattern is Wrong'
});
driverValidations.push({
    reg: regCusAddress,
    field: $('#address'),
    error: 'Diver Address Pattern is Wrong'
});
driverValidations.push({
    reg: regEmailCusAddress,
    field: $('#email'),
    error: 'Diver Email Address Pattern is Wrong'
});
driverValidations.push({
    reg: regNIC,
    field: $('#nic'),
    error: 'Diver NIC Pattern is Wrong'
});
driverValidations.push({
    reg: regDrivingNIC,
    field: $('#license_No'),
    error: 'Diver Driving License Pattern is Wrong'
});
driverValidations.push({
    reg: regUserName,
    field: $('#user_Name'),
    error: 'Diver User Name Pattern is Wrong'
});
driverValidations.push({
    reg: regPassword,
    field: $('#password'),
    error: 'Diver Password Pattern is Wrong'
});
